        ...
        <div className="steps flex items-center flex-col justify-center my-32">
            ...
            <div className="space-y-4 w-full max-w-3xl">
                {stepsData.map( (d,index) => (
                    <div key={d.id} className="flex items-center p-5 px-8 gap-4 bg-white/40 shadow-md border border-gray-200 rounded-lg hover:scale-[1.02] transition-all duration-300">
